...
if( $_SESSION["userlogin"] == 1  || $user["client_type"] == 1 || $settings["resetpass_page"] == 1  ){
...
if( $_POST ):
  ...
  $type = $_POST["type"];
    ...
    elseif( $settings["recaptcha"] == 2 && $captcha_control->success == false ):
      ...
      if( $type == "email" ):
        $send = sendMail(["subject"=>"Hesabınıza ait yeni şifre.","body"=>"Hesabınıza ait yeni şifreniz :".$pass,"mail"=>$row["email"]]);
      endif;
